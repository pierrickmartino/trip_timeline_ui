...
class Preference extends DataClass implements Insertable<Preference> {
  ...
  factory Preference.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Preference(
      id: intType.mapFromDatabaseResponse(data['${effectivePrefix}id']),
      parameterId: intType
          .mapFromDatabaseResponse(data['${effectivePrefix}parameter_id']),
      preference: stringType
          .mapFromDatabaseResponse(data['${effectivePrefix}preference']),
      creationDate: dateTimeType
          .mapFromDatabaseResponse(data['${effectivePrefix}creation_date']),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || parameterId != null) {
  ...
  PreferencesCompanion toCompanion(bool nullToAbsent) {
    return PreferencesCompanion(
      id: id == null && nullToAbsent ? const Value.absent() : Value(id),
      parameterId: parameterId == null && nullToAbsent
          ? const Value.absent()
          : Value(parameterId),
      preference: preference == null && nullToAbsent
          ? const Value.absent()
  ...
  int get hashCode => $mrjf($mrjc(
      id.hashCode,
      $mrjc(parameterId.hashCode,
          $mrjc(preference.hashCode, creationDate.hashCode))));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is Preference &&
...
class $PreferencesTable extends Preferences
  ...
  final VerificationMeta _parameterIdMeta =
      const VerificationMeta('parameterId');
  GeneratedIntColumn _parameterId;
  @override
  GeneratedIntColumn get parameterId =>
      _parameterId ??= _constructParameterId();
  GeneratedIntColumn _constructParameterId() {
    return GeneratedIntColumn('parameter_id', $tableName, false,
        $customConstraints: 'NULL REFERENCES parameters(id)');
  }
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, parameterId, preference, creationDate];
  @override
  ...
  Preference map(Map<String, dynamic> data, {String tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : null;
    return Preference.fromData(data, _db, prefix: effectivePrefix);
  }
...
abstract class _$Database extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [parameters, preferences];
}
